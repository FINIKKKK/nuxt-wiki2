<template>
  ...
  <div class="controls">
    ...
    <div class="btns">
      ...
      <!-- Настройки -->
      <svg-icon name="options" class="options" />
    </div>
  </div>
...
//   const params = {
//     company_id: teamStore.Company?.id,
...
const onSubmit = async () => {
  // Объект с данными
  const dto = {
    team_id: teamStore.activeTeam?.id,
    name: titleValue.value,
    blocks: bodyValue.value,
    // ...(selectValue.value && { section_id: selectValue.value }),
  };
